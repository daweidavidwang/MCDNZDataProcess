...
folder_train  = 'G:\DatasetWithSecondFeature_aug2NewSize\ttt';  %%% training
folder_val   = 'G:\DatasetWithSecondFeature_aug2NewSize\ttt';%%% testing
folder = 'G:\DatasetWithSecondFeature_aug2NewSize\';
...
%%% testing  patches
[inputs,labels,set] = PatchGenerationRGBonly(size_input,size_label,stride_test,folder,folder_train,val_train,max_numPatches,batchSize);
[inputs2,labels2,set2] = PatchGenerationRGBonly(size_input,size_label,stride_test,folder,folder_val,val_test,max_numPatches,batchSize);
