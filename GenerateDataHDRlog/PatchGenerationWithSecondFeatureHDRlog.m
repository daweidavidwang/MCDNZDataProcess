function [inputs, labels, set] = PatchGenerationWithSecondFeatureHDRlog(size_input,size_label,stride,folder,folderpa,mode,max_numPatches,batchSize)
PatchSelect = 0;
featureNum = 17;
