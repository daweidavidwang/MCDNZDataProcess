...
folderTestGt  = fullfile('I:\DatasetWithSecondFeature_aug2\TrainSetSS\3'); %%% test dataset
folderTestPre = fullfile('E:\TraiSetTest');
showResult  = 0;
useGPU      = 0;
pauseTime   = 0; 
saveresult = 1;
...
for epoch = 28:10:28
epoch       = 26;
load('I:\NetModel\HDR_BN15_L1_Aug2ss\data\model_MC_Res_Bnorm_Adam\model_MC_Res_Bnorm_Adam-epoch-98.mat');
...
for i = 1:length(filePaths)
    ...
    input_jpg =  tanh(0.5636*exrread( fullfile(folderTest,[filePaths(i).name(1:end-4),'_MC_0004.exr'] ) ));
