function [inputs,subNum,order,set] = mat_patches_generation_log_inputs(size_input,size_label,stride,folder,mode,max_numPatches,batchSize)
...
for i = 1 : length(filepathsGt)
    ...
    for index = 1:length(spp) 
        ...
        for j = 1:1
            ...
            clear im_label;clear im_data; clear subim_input; clear subim_label;clear labels;
        end
    end
