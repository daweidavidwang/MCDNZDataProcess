...
folder_train  = 'G:\DatasetWithSecondFeature_aug2\TrainSetSS';  %%% training
folder_val   = 'G:\DatasetWithSecondFeature_aug2\TrainSetSS';%%% testing
...
%%% testing  patches
[inputs,labels,set] = PatchHDRtanhLowpass(size_input,size_label,stride_test,folder,folder_train,val_train,max_numPatches,batchSize);
[inputs2,labels2,set2] = PatchHDRtanhLowpass(size_input,size_label,stride_test,folder,folder_val,val_test,max_numPatches,batchSize);
