function [inputs, labels, set] = mat_patches_generation_tanh(size_input,size_label,stride,folder,mode,max_numPatches,batchSize)
...
for i = 1 : length(filepathsGt)
    ...
    for index = 1:length(spp) 
        ...
        input_im(:,:,1:3) = tanh(0.536*input_exr);
        clear input_exr;
