function [inputs, labels, set] = mat_patches_generation6(size_input,size_label,stride,folder,mode,max_numPatches,batchSize)
...
exrName = ['_MC_0004.exr';'_MC_0008.exr';'_MC_0016.exr';'_MC_0032.exr';'_MC_0064.exr'];
